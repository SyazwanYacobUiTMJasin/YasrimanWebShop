...
public class UserService {
    ...
    private String generateWelcomeEmail(User user) {
        return "<!DOCTYPE html>"
                ...
                + "    <a href='https://yasrimanplants-849d21e8dcf1.herokuapp.com/inventory?action=viewallproducts' class='shopnowbutton'>"
                + "      SHOP NOW"
                + "      <img src='cid:arrowIcon' alt='arrow icon' draggable='false' />"
                + "    </a>"
                + "  </div>"
                + "</div>"
                + "</body>"
